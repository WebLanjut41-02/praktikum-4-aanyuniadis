 ...
 <!-- ##### Hero Area Start ##### -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <img src="<?php echo base_url()?>assets/Project/img/bg-img/c2.jpg" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                            <h4>Vocabulary</h4>
                            <div class="meta d-flex align-items-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="750ms">
                        <img src="<?php echo base_url()?>assets/Project/img/bg-img/c3.jpg" alt="">
                        <!-- Course Content -->
                        <div class="course-content">
                    ...
                    <div class="tutors-slide owl-carousel wow fadeInUp" data-wow-delay="250ms">
                        ...
                        <div class="single-tutors-slides">
                            ...
                            <div class="tutor-thumbnail">
                                <img src="<?php echo base_url()?>assets/Project/img/bg-img/t1.png" alt="">
                            </div>
                            <!-- Tutor Information -->
    ...
    <!-- ##### Register Now Start ##### -->
    <section class="register-now section-padding-100-0 d-flex justify-content-between align-items-center" style="background-image: url(<?php echo base_url()?>assets/Project/img/core-img/texture.png);">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-upcoming-events mb-50 wow fadeInUp" data-wow-delay="250ms">
                        ...
                        <div class="events-thumb">
                            <img src="<?php echo base_url()?>assets/Project/img/bg-img/e1.jpg" alt="">
