...
<body>
    ...
    <header class="header-area">
        ...
        <div class="top-header-area d-flex justify-content-between align-items-center">
            ...
            <div class="contact-info">
                <a href="#"><span>Phone:</span> +62 300 303 0266</a>
                <a href="#"><span>Email:</span> u-project@gmail.com</a>
            </div>
            <!-- Follow Us -->
            <div class="follow-us">
                <span>Follow us</span>
        ...
        <div class="clever-main-menu">
            <div class="classy-nav-container breakpoint-off">
                ...
                <nav class="classy-navbar justify-content-between" id="cleverNav">
                    ...
                    <!-- Logo -->
                    <a class="nav-brand" href="<?php echo base_url()?>assets/Project/index.php"><img src="<?php echo base_url()?>assets/Project/img/core-img/logo.png" alt=""></a>
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            <ul>
                                ...
                                <li><a href="#">Pages</a>
                                   <ul class="dropdown">
                                        <li><a href=<?php echo base_url()?>assets/Project/index.php">Home</a></li>
                                        <li><a href="<?php echo base_url()?>assets/Project/project.php">Project</a></li>
                                        <li><a href="<?php echo base_url()?>assets/Project/detailproject.php">Detail Project</a></li>
                                        <li><a href="<?php echo base_url()?>assets/Project/tanggapan.php">Tanggapan User</a></li>
                                        <li><a href="<?php echo base_url()?>assets/Project/artikel.php">Artikel</a></li>
                                        <li><a href="<?php echo base_url()?>assets/Project/detailartikel.php">Detail Artikel</a></li>
                                        <li><a href="<?php echo base_url()?>assets/Project/benefit.php">Benefit</a></li>
                                        <li><a href="<?php echo base_url()?>assets/Project/kontak.php">Kontak</a></li>
                                    </ul>
                                </li>
                                <li><a href="<?php echo base_url()?>assets/Project/project.php">Project</a></li>
                                <li><a href="<?php echo base_url()?>assets/Project/tanggapan.php">Tanggapan User</a></li>
                            ...
                            <div class="register-login-area">
                                <a href="regis.php" class="btn">Register</a>
    ...
    <!-- ##### Hero Area Start ##### -->
    <section class="hero-area bg-img bg-overlay-2by5" style="background-image: url(<?php echo base_url()?>assets/Project/img/bg-img/a1.jpg);">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-cool-facts-area text-center mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <div class="icon">
                            <img src="<?php echo base_url()?>assets/Project/img/core-img/docs.png" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-cool-facts-area text-center mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <div class="icon">
                            <img src="<?php echo base_url()?>assets/Project/img/core-img/star.png" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-cool-facts-area text-center mb-100 wow fadeInUp" data-wow-delay="750ms">
                        <div class="icon">
                            <img src="<?php echo base_url()?>assets/Project/img/core-img/events.png" alt="">
                        </div>
                        <h2><span class="counter">123</span></h2>
                        <h5>Project Maker</h5>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-cool-facts-area text-center mb-100 wow fadeInUp" data-wow-delay="1000ms">
                        <div class="icon">
                            <img src="<?php echo base_url()?>assets/Project/img/core-img/earth.png" alt="">
                        </div>
    ...
    <section class="popular-courses-area section-padding-100-0" style="background-image: url(<?php echo base_url()?>assets/Project/img/core-img/texture.png);">
        <div class="container">
            <div class="row">
                <div class="col-12">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="<?php echo base_url()?>assets/Project/img/bg-img/c1.jpg" alt="">
                        <!-- Course Content -->
                ...
                <div class="col-12">
                    <div class="tutors-slide owl-carousel wow fadeInUp" data-wow-delay="250ms">
                        ...
                        <div class="single-tutors-slides">
                            <!-- Tutor Thumbnail -->
                            <div class="tutor-thumbnail">
                                <img src="<?php echo base_url()?>assets/Project/img/bg-img/t2.png" alt="">
                            </div>
                            <!-- Tutor Information -->
                            <div class="tutor-information text-center">
                                <h5>Alex Parker</h5>
                        ...
                        <div class="single-tutors-slides">
                            <!-- Tutor Thumbnail -->
                            <div class="tutor-thumbnail">
                                <img src="<?php echo base_url()?>assets/Project/img/bg-img/t3.png" alt="">
                            </div>
                            <!-- Tutor Information -->
                            <div class="tutor-information text-center">
                                <h5>Alex Parker</h5>
                        ...
                        <div class="single-tutors-slides">
                            <!-- Tutor Thumbnail -->
                            <div class="tutor-thumbnail">
                                <img src="<?php echo base_url()?>assets/Project/img/bg-img/t4.png" alt="">
                            </div>
                            <!-- Tutor Information -->
                            <div class="tutor-information text-center">
                                <h5>Alex Parker</h5>
                        ...
                        <div class="single-tutors-slides">
                            <!-- Tutor Thumbnail -->
                            <div class="tutor-thumbnail">
                                <img src="<?php echo base_url()?>assets/Project/img/bg-img/t5.png" alt="">
                            </div>
                            <!-- Tutor Information -->
                            <div class="tutor-information text-center">
                                <h5>Alex Parker</h5>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-upcoming-events mb-50 wow fadeInUp" data-wow-delay="500ms">
                        <!-- Events Thumb -->
                        <div class="events-thumb">
                            <img src="<?php echo base_url()?>assets/Project/img/bg-img/e2.jpg" alt="">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-upcoming-events mb-50 wow fadeInUp" data-wow-delay="750ms">
                        <!-- Events Thumb -->
                        <div class="events-thumb">
                            <img src="<?php echo base_url()?>assets/Project/img/bg-img/e3.jpg" alt="">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="single-blog-area mb-100 wow fadeInUp" data-wow-delay="250ms">
                        <img src="<?php echo base_url()?>assets/Project/img/blog-img/1.jpg" alt="">
                        <!-- Blog Content -->
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="footer-logo">
                            <a href="<?php echo base_url()?>assets/Project/index.php"><img src="<?php echo base_url()?>assets/Project/img/core-img/logo2.png" alt=""></a>
                        </div>
                        <!-- Copywrite -->
                        <p><a href="#"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">U - Project</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
        ...
        <div class="bottom-footer-area d-flex justify-content-between align-items-center">
            ...
            <div class="contact-info">
                ...
                <a href="#"><span>Email:</span> U-Project@gmail.com.com</a>
            </div>
            <!-- Follow Us -->
            <div class="follow-us">
                <span>Follow us</span>
